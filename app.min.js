  ...
  if (fullscreenImg) {
    ...
    fullscreenImg._fullscreenTouchEnd = (e) => {
      if (e.changedTouches.length === 1) {
        ...
        // Если это был свайп (горизонтальное движение больше вертикального)
        if (isSwiping && deltaX > 50 && deltaX > deltaY) {
          ...
          // Если это был тап (маленькое движение) - закрываем полноразмерный просмотр
