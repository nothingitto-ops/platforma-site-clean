...
function toggleMobileZoom() {
  ...
  if (isZoomed) {
    ...
    mobileMainImg.style.transform = 'scale(1.65) translate(0, 0)';
...
function addPanHandlers() {
  ...
  mobileMainImg._panMove = (e) => {
    ...
    // При зуме 1.65x изображение увеличивается в 1.65 раза
    const zoomedImgWidth = imgWidth * 1.65;
    const zoomedImgHeight = imgHeight * 1.65;
    ...
    mobileMainImg.style.transform = `scale(1.65) translate(${clampedX}px, ${clampedY}px)`;
    e.preventDefault();
  };
