...
function addCardEventListeners() {
  ...
  cards.forEach(card => {
    ...
    if (item) {
      ...
      // Убираем все touch обработчики - оставляем только click для избежания конфликтов со скроллингом
...
function addPanHandlers() {
  const mobileMainImg = document.getElementById('mobileMainImg');
  if (!mobileMainImg) {
    console.error('mobileMainImg not found');
    return;
  }
  ...
  console.log('Pan handlers initialized');
  ...
  mobileMainImg._panMove = (e) => {
    ...
    const container = mobileMainImg.parentElement;
    ...
    const parentContainer = mobileMainImg.parentElement;
    if (parentContainer) {
      parentContainer.style.pointerEvents = 'auto';
      parentContainer.style.touchAction = 'pan-x pan-y';
    }
