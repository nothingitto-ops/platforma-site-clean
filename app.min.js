  ...
  if (mobileZoomImg) {
    ...
    if (current && current.images.length > 1) {
      ...
      mobileZoomImg._swipeTouchStart = (e) => {
        ...
        if (isZoomedNow) {
          isSwiping = false;
          // НЕ блокируем touchstart - разрешаем панорамирование
          return;
        }
      ...
      mobileZoomImg._swipeTouchEnd = (e) => {
        ...
        if (isCurrentlyZoomed) {
          isSwiping = false;
          isZoomed = true;
          // НЕ блокируем touchend - разрешаем панорамирование
          return;
        }
      ...
      mobileZoomImg.addEventListener('gesturechange', (e) => {
        ...
        if (isZoomed) {
          ...
          // Больше не добавляем CSS класс - используем только JavaScript блокировку
