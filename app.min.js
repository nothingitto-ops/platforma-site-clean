...
function openFullscreenGallery(e) {
  console.log('openFullscreenGallery called');
  const fullscreenGallery = document.getElementById('fullscreenGallery');
  const fullscreenImg = document.getElementById('fullscreenImg');
  const fullscreenCounter = document.getElementById('fullscreenCounter');
  const mobileMainImg = document.getElementById('mobileMainImg');
  
  console.log('Elements found:', { fullscreenGallery, fullscreenImg, fullscreenCounter, mobileMainImg });
...
function addFullscreenEventHandlers() {
  ...
  if (fullscreenImg && current && current.images.length > 1) {
...
function updateFullscreenCounter() {
  const fullscreenCounter = document.getElementById('fullscreenCounter');
  if (fullscreenCounter && current && current.images.length > 1) {
    fullscreenCounter.textContent = `${curIndex + 1} / ${current.images.length}`;
  }
}
