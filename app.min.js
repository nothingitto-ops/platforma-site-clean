    ...
    if (current && current.images.length > 1) {
      ...
      mobileZoomImg._swipeTouchMove = (e) => {
        if (e.touches.length === 1) {
          ...
          const currentScale = getCurrentScale(mobileZoomImg);
          const isCurrentlyZoomed = currentScale > 1.01;
          
          // Отладочная информация
          console.log('TouchMove - Scale:', currentScale, 'isZoomed:', isCurrentlyZoomed);
          
          // Визуальный индикатор на экране
          showDebugInfo('TouchMove', currentScale, isCurrentlyZoomed);
      ...
      mobileZoomImg._swipeTouchEnd = (e) => {
        ...
        // Отладочная информация
        console.log('TouchEnd - Scale:', currentScale, 'isZoomed:', isCurrentlyZoomed);
        
        // Визуальный индикатор на экране
        showDebugInfo('TouchEnd', currentScale, isCurrentlyZoomed);
