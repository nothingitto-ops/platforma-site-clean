...
function closeMobileModal() {
  ...
  if (mobileModal) {
    ...
    document.body.style.overflow = '';
    document.body.classList.remove('modal-open'); // Удаляем класс для разблокировки каталога
  }
...
function closeMobileZoom() {
  ...
  if (mobileZoomModal) {
    ...
    document.body.classList.add('modal-open'); // Возвращаем блокировку каталога
  }
}
