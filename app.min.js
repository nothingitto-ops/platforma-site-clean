...
function toggleMobileZoom() {
  ...
  if (isZoomed) {
    ...
    mobileMainImg.style.transform = 'scale(1.35) translate(0, 0)';
    mobileMainImg.style.webkitTransform = 'scale(1.35) translate(0, 0)';
...
function addPanHandlers() {
  ...
  mobileMainImg._panMove = (e) => {
    ...
    // При зуме 1.35x изображение увеличивается в 1.35 раза
    const zoomedImgWidth = imgWidth * 1.35;
    const zoomedImgHeight = imgHeight * 1.35;
    ...
    mobileMainImg.style.transform = `scale(1.35) translate(${clampedX}px, ${clampedY}px)`;
    
    // Принудительно обновляем стили
    mobileMainImg.style.webkitTransform = `scale(1.35) translate(${clampedX}px, ${clampedY}px)`;
    
    // Отладочная информация
    console.log('Applied transform:', `scale(1.35) translate(${clampedX}px, ${clampedY}px)`);
