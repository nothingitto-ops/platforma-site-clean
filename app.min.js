...
function addPanHandlers() {
  const mobileMainImg = document.getElementById('mobileMainImg');
  const mobileMainImage = document.querySelector('.mobile-main-image');
  if (!mobileMainImg || !mobileMainImage) return;
  ...
  mobileMainImg._panMove = (e) => {
    ...
    const containerWidth = mobileMainImage.offsetWidth;
    const containerHeight = mobileMainImage.offsetHeight;
    ...
    const mobileMainImage = document.querySelector('.mobile-main-image.zoomed');
    if (mobileMainImage) {
      mobileMainImage.style.pointerEvents = 'auto';
      mobileMainImage.style.touchAction = 'pan-x pan-y';
    }
