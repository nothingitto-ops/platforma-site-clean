  ...
  if (mobileZoomImg) {
    ...
    if (current && current.images.length > 1) {
      ...
      mobileZoomImg._swipeTouchStart = (e) => {
        ...
        console.log('TouchStart - isZoomed:', isZoomed, 'ViewportScale:', viewportScale);
        
        // Визуальный индикатор на экране
        showDebugInfo('TouchStart', isZoomed ? 2 : 1, isZoomed);
      ...
      mobileZoomImg._swipeTouchMove = (e) => {
        if (e.touches.length === 1) {
          ...
          // Отладочная информация
          console.log('TouchMove - isZoomed:', isCurrentlyZoomed, 'ViewportScale:', viewportScale);
          
          // Визуальный индикатор на экране
          showDebugInfo('TouchMove', isCurrentlyZoomed ? 2 : 1, isCurrentlyZoomed);
